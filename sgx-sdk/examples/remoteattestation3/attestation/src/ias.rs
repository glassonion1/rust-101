...
const DEV_HOSTNAME: &'static str = "api.trustedservices.intel.com";
const SIGRL_SUFFIX: &'static str = "/sgx/dev/attestation/v4/sigrl/";
const REPORT_SUFFIX: &'static str = "/sgx/dev/attestation/v4/report";
...
impl Client {
    pub fn new(ias_key: String) -> Client {
        Client { ias_key }
    }

    pub fn get_sigrl(&self, gid: u32) -> Result<Vec<u8>, sgx_status_t> {
        ...
        headers.insert("Ocp-Apim-Subscription-Key", &self.ias_key);
    ...
    pub fn post_report(&self, quote: Vec<u8>) -> Result<(String, String, String), sgx_status_t> {
